    ...
    <>
      ...
      <div className={styles.page}>
        <div className={styles.card}>
          ...
          <div className={styles.cardLbl}>Principal Portal</div>
          <h1 className={styles.cardH}>Welcome, Principal</h1>
          <p className={styles.cardSub}>
            Access your property portfolio, inspection calendar, and client enquiries.
          </p>
          ...
          {!showOtp && (
            <div>
              ...
              <div className={styles.infoBox}>
                Credentials are provided by RokHaven after property listing. To list your first property:{' '}
          ...
          <div className={styles.cardFoot}>
            Are you a Client?{' '}
            <Link href="/auth/client-login">Client Login →</Link>
          </div>
        </div>
      </div>
    </>
